      ...
      <CardItem v-for="project in projects" :key="project.id">
        <template #card-header>
          ...
          <div class="flex items-center">
            <a v-if="project.websiteUrl" :href="project.websiteUrl" class="mr-2" aria-label="Website">
        ...
        <ul v-if="project.tags.length" class="flex mb-4">
          <li v-for="tag in project.tags" :key="tag" class="mr-2 text-sm bg-indigo-100 px-1 rounded-lg dark-mode:bg-red-800">{{ tag }}</li>
        </ul>
